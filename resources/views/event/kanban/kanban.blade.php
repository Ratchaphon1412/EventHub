    ...
    @if($kanban !=null)
      <script >
          ...
          var KanbanTest = new jKanban({
              ...
              itemHandleOptions:{
                enabled: true,
                customHandler:'<div class="item_handle w-full h-64 flex flex-col justify-between bg-pink-300 rounded-lg border border-pink-300 mb-6 py-5 px-4"><div><h4 class="text-gray-800 font-bold mb-3">%title%</h4><p class="text-gray-800 text-sm">%description%</p></div><div><div class="flex items-center justify-between text-gray-800"><p class="text-sm"></p><div class="flex flex-row gap-2"><button class="w-8 h-8 rounded-full bg-gray-800 text-white flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 ring-offset-pink-300   focus:ring-black" aria-label="edit note" role="button" data-modal-target="popup-modal-edit" data-modal-toggle="popup-modal-edit" onClick="editPostIt(this)" data-id="%id%" ><img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/4-by-3-multiple-styled-cards-svg1.svg" alt="edit" /><img class="dark:block hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/4-by-3-multiple-styled-cards-svg1dark.svg" alt="edit"  /></button><button   class="w-8 h-8 rounded-full bg-red-600 text-white flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 ring-offset-pink-300   focus:ring-black" aria-label="delete note " role="button" data-id="%id%" onclick="deletePostIT(this)" data-modal-target="popup-modal" data-modal-toggle="popup-modal" ><i class="bi bi-trash3" data-id="%id%" ></i></button></div></div></div></div>',
              },
              click: function(el) {
