...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="flex flex-col w-full container">
        ...
        <div class="flex flex-row justify-around">
                ...
                <x-card-certificate route="" title="NMU" dateStart="666" dateEnd="777" image="https://images.unsplash.com/photo-1523731407965-2430cd12f5e4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80"></x-card-certificate>
