<x-app-layout>
    ...
    <!-- Parallax Background -->
    <section id="coverImage" class="justify-center items-center  w-full h-[400px] bg-fixed w-full  rounded-lg  bg-cover bg-no-repeat " style="background-image:url({{asset('public/assets/images/background/landing.jpg')}})" >
