    ...
    <main class="flex-col justify-center items-center ">
        ...
        <section id="Form" class="grid grid-6 md:grid-cols-1">
            ...
            <section id="Title" class="">
                <section id="Title" class="grid col-span-full w-full mt-10 items-start">
            ...
            <section id="Category & Datepicker" class="grid grid-2">
            ...
            <!-- Google Map -->
            <div class="relative flex justify-center w-full h-full rounded-xl mt-10">
